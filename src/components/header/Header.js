...
function Header() {
  return (
    <div className="flex justify-between py-5 px-7 border-b-[1px] border-textDark/20 items-center bg-bgPrimary">
      <div>
        <a
          href="/"
          className="text-textPrimary font-bold text-[36px] leading-10 font-primary"
        >
          LoGo
        </a>
      </div>
